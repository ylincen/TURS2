...
for fold in range(5):
    ...
    alg_config = AlgConfig(
        ...
        validity_check=False, rerun_on_invalid=False, rerun_positive_control=False,
...
folder_name = "NEW_exp_uci_" + date_and_time[:8] + "validity_check_" + validity_check_ + "_not_use_excl_" + str(not_use_excl_)
...
# overlap_prob_diffs_max = exp_res_df["overlap_prob_diffs_max"].to_numpy()
# overlap_prob_diffs_mean = exp_res_df["overlap_prob_diffs_mean"].to_numpy()
# overlap_modelling_group_coverage = exp_res_df["modelling_group_coverage"].to_numpy()
# tmp = []
# for i in range(len(overlap_prob_diffs_max[0])):
#     tmp.append((overlap_prob_diffs_max[0][i], overlap_modelling_group_coverage[0][i]))