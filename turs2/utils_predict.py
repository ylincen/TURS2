...
def get_rule_cover(rule, X_test):
    # This functions calculates the cover of this given rule on the test data
...
# def get_ruleset_cover(ruleset, X_test):
#     # This functions calculates the cover of the ruleset on the test data
#     if type(X_test) != np.ndarray:
#         X_test = X_test.to_numpy()
#
#     rules_cover = []
...
#         rule_cover = get_rule_cover(rule, X_test)
#         rules_cover.append(rule_cover)
#
#     return rules_cover
